    ...
    <div className="min-h-screen bg-gradient-to-b from-[#F0F5FF] to-white">
      ...
      >
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <Button onClick={() => setIsLoginOpen(true)} className="bg-[#0ea5e9] hover:bg-[#0284c7] text-white">
              Acceder
            </Button>
          </div>
        </div>
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        <motion.div
          ...
          className="absolute top-20 right-10 w-96 h-96 bg-[#0ea5e9]/5 rounded-full blur-3xl -z-10"
        />
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 1 }}>
              ...
              <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }} className="text-lg text-gray-600 mb-8 max-w-lg">
                {hero.description}
              </motion.p>
            ...
            <motion.div
              ...
              transition={{ duration: 1.4, delay: 0.4 }} className="relative"
            >
      ...
      <footer className="text-white py-12 px-6 bg-primary-foreground">
        <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-secondary-foreground">colegiodgmisiones@gmail.com</p>
          </div>
